...
function StudentName(){
    let formated = Student.map((stu)=>{return (
            <>
                 <tr>
                    <td rowSpan={9}><img src={stu.avatar}/></td>
                </tr>
            <tr><td>{stu.id}</td></tr>
            <tr><td>{stu.createdAt}</td></tr>
            <tr><td>{stu.name}</td></tr>
            <tr><td>{stu.department}</td></tr>
            <tr><td>{stu.roll_no}</td></tr>
            <tr><td>{stu.city}</td></tr>
            <tr><td>{stu.password}</td></tr>
            <tr><td>{stu.username}</td></tr>
            </>
    )
    })
    return formated;
